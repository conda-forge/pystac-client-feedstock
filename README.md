...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pystac-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12557&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pystac-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pystac-client` can be installed with:

```
conda install pystac-client
```

It is possible to list all of the versions of `pystac-client` available on your platform with:
